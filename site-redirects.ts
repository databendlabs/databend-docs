const siteRedirects = [
  ...
  },
  {
    ...
    to: '/sql/sql-functions/semi-structured-functions/array-construct'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-array-distinct',
    to: '/sql/sql-functions/semi-structured-functions/array-distinct'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-array-except',
    to: '/sql/sql-functions/semi-structured-functions/array-except'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-array-insert',
    to: '/sql/sql-functions/semi-structured-functions/array-insert'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-array-intersection',
    to: '/sql/sql-functions/semi-structured-functions/array-intersection'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-array-overlap',
    to: '/sql/sql-functions/semi-structured-functions/array-overlap'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-object-insert',
    to: '/sql/sql-functions/semi-structured-functions/object-insert'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-object-delete',
    to: '/sql/sql-functions/semi-structured-functions/object-delete'
  },
  {
    from: '/sql/sql-functions/semi-structured-functions/json-object-pick',
    to: '/sql/sql-functions/semi-structured-functions/object-pick'
  },
  {
