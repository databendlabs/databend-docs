...
2. 如果您更新 Databend 中的源表，您可以在 Databend Cloud 上的附加表中观察到相同的更改。 例如，如果您将源表中 Toronto 的人口更改为 2,371,571：
...
3. 如果您从源表中删除 `province` 列，则该列将不再在附加表中可用于查询。
