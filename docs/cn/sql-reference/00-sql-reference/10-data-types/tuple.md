...
| 名称  | 别名 | 值                                          | 描述                                                                                               |
|-------|---------|-------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| TUPLE |         | ('2023-02-14 08:00:00','Valentine's Day') | 有序的、不可变的集合，需要在使用前声明每个元素的类型。 |

Tuple 是一个有序的、不可变的异构元素集合，在大多数编程语言中用括号 () 表示。换句话说，Tuple 是不同数据类型的元素的有限有序列表，一旦创建，其元素就不能更改或修改。
