...
[TO_DATE](../../20-sql-functions/05-datetime-functions/to-date.md) 和 [TO_TIMESTAMP](../../20-sql-functions/05-datetime-functions/to-timestamp.md)) 要求您指定所需的日期和时间值的格式. 为了处理日期和时间格式化, Databend
