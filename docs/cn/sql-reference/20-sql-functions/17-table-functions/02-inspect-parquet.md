...
| num_row_groups               | Parquet 文件中行组的计数                                       |
...
此示例从名为 [books.parquet](https://datafuse-1253727613.cos.ap-hongkong.myqcloud.com/data/books.parquet) 的已暂存示例 Parquet 文件中检索元数据。该文件包含两条记录：
