...
| 列                | 数据类型           | 描述                                                                                                                                                                                           |
|-------------------|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| VALIDITY_SIZE     | Nullable(UInt32)   | 一个 bitmap 值的大小，用于指示列中的每一行是否具有非空值。此 bitmap 用于跟踪列数据中是否存在空值。                                                                                                              |
| COMPRESSED_SIZE   | UInt32             | 压缩后的列数据大小。                                                                                                                                                                         |
| UNCOMPRESSED_SIZE | UInt32             | 应用编码之前的列数据大小。                                                                                                                                                                     |
