...
`QUANTILE_DISC()` 函数用于计算数值数据序列的精确分位数。
...
| 参数       | 描述                                                                                                                                       |
|------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| `level(s)` | 分位数的 level。每个 level 都是从 0 到 1 的常量浮点数。我们建议使用 [0.01, 0.99] 范围内的 level 值。                                                                                             |
| `<expr>`   | 任何数值表达式                                                                                                                             |

## 返回类型

基于 level 数量的 InputType 或 InputType 数组。
