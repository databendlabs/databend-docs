...
主要代码实现在[这里](https://github.com/databendlabs/databend/blob/1e93c5b562bd159ecb0f336bb88fd1b7f9dc4a62/src/common/openai/src/completion.rs)。
...
该函数接受一个文本提示作为输入，并返回一个为该提示生成的补全。补全是使用大型文本语料库上的预训练模型创建的，捕获了连续空间中单词和短语之间的关系。

## 使用 ai_text_completion 生成文本补全

以下是一个简单的示例，使用 Databend 中的 `ai_text_completion` 函数生成文本补全：
