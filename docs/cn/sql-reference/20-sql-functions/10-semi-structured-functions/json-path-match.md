...
检查指定的 JSON 路径表达式是否与 JSON 数据中的某些条件匹配。请注意，`@@` 运算符与此函数同义。有关更多信息，请参见 [JSON Operators](../../10-sql-commands/30-query-operators/index.md)。
...
-- 检查 JSON 路径 $.b 处的数组中从第二个到最后一个的任何元素是否大于或等于 2
