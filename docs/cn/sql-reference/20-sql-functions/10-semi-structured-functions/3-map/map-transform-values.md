...
使用 [lambda 表达式 (Lambda Expression)](../../../00-sql-reference/42-lambda-expressions.md) 对 JSON 对象 (JSON Object) 中的每个值应用转换。
...
返回一个 JSON 对象，其键与输入 JSON 对象相同，但值已根据指定的 lambda 转换进行了修改。
