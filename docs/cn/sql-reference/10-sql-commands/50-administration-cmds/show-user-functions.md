...
列出系统中存在的用户定义函数和外部函数。等同于 `SELECT name, is_aggregate, description, arguments, language FROM system.user_functions ...`。

另见：[system.user_functions](../../00-sql-reference/20-system-tables/system-user-functions.md)
