...
| arg_name_to_mask       	| 需要被屏蔽的原始数据参数的名称。                                                                                                     	|
| arg_type_to_mask       	| 需要被屏蔽的原始数据参数的数据类型。                                                                                                 	|
| expression_on_arg_name 	| 一个表达式，用于确定如何处理原始数据以生成屏蔽数据。                                                                                     	|
...
此示例说明了设置 masking policy 以根据用户角色选择性地显示或屏蔽敏感数据的过程。
