...
显示有关 Databend 中特定密码策略的详细信息。有关密码策略属性的详细说明，请参阅 [密码策略属性](create-password-policy.md#password-policy-attributes)。
...
│ PASSWORD_MAX_RETRIES          │ 5           │ 5                │ 用户在帐户被锁定之前输入正确密码的尝试次数。                                                                                                                     │
