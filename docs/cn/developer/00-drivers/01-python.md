...
在以下教程中，您将学习如何使用上述包来开发您的Python应用程序。本教程将指导您在Databend中创建SQL用户，然后编写Python代码创建表、插入数据和执行数据查询。
...
在开始之前，请确保您已成功创建了数据仓库并获得了连接信息。有关如何操作，请参阅[连接到数据仓库](/guides/cloud/using-databend-cloud/warehouses#connecting)。
