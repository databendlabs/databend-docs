...
1. 将以下参数添加到配置文件 [databend-query.toml](https://github.com/databendlabs/databend/blob/main/scripts/distribution/configs/databend-query.toml) 的 [log] 部分。有关每个参数的详细说明，请参阅 [[log.tracing] 部分](../../04-references/node-config/query-config.md#logtracing-section)。
