...
**场景描述**
之前，我们介绍了如何在 [部署](https://docs.databend.com/guides/self-hosted/deployment/production/metasrv-deploy#step-2-deploy-query-nodes) 中使用静态 `tenant_id` 和 `cluster_id` 部署 Databend。
