...
本页列出当前可用的企业版功能。如需使用，请获取企业或试用许可证，详见 [Databend 许可](license.md)。
...
| [数据血缘 (Data Lineage)](/guides/data-management/data-lineage)                            | 数据治理 | 追踪表、视图、Stage 和列之间的上下游依赖关系。 |
...
| [Python UDF](/sql/sql-commands/ddl/udf/ddl-create-function#python)                       | 高级分析 | 在 SQL 查询中通过内置处理器执行 Python 代码。                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| [VACUUM DROPPED OBJECTS](/sql/sql-commands/ddl/table/vacuum-dropped-objects) | 存储管理 | 永久清理符合条件的已删除对象及其存储和元数据。清理后的对象无法恢复。 |
