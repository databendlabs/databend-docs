...
[Deepnote](https://deepnote.com) 允许你与朋友和同事在一个地方实时协作，轻松处理数据科学项目，从而更快地将想法和分析转化为产品。Deepnote 专为浏览器构建，因此你可以在任何平台（Windows、Mac、Linux 或 Chromebook）上使用它。无需下载，每日为你推送更新。所有更改都会立即保存。
...
一切就绪！有关如何使用该工具的信息，请参阅 Deepnote 文档。
