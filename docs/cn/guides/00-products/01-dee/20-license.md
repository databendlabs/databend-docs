...
要访问 Databend 企业版功能，需要从 Databend 获得付费许可，并且这些功能也受 Elastic 许可的约束。如需其他自定义许可选项，请随时[联系我们](https://www.databend.com/contact-us)。

:::note
您可以通过查看 [Databend 存储库](https://github.com/databendlabs/databend) 下的代码文件头来找到该功能的许可证
:::
...
<details>
  <summary>为什么 Databend 为企业功能选择 Elastic License 2.0？</summary>
   <p></p>
...
仅应用三个限制：<br/>
1. 不能提供软件作为托管或管理服务，并能大量访问特性/功能。<br/>
2. 不能修改或规避许可证密钥功能，也不能删除/模糊受保护的功能。<br/>
3. 不能更改/删除/许可软件中许可方、版权或商标声明。
</details>

<details>
  <summary>我想在我的软件中重用 Databend 项目中的一些组件，该软件使用 Agpl 或其他开源许可证，这可能吗？</summary>
   <p></p>
   Databend 团队致力于支持开源社区，并愿意考虑提取通常有用的特定内部组件，作为具有自己许可证（例如 APL）的单独项目。
</details>

<details>
  <summary>您能否提供一些关于什么符合“作为托管或管理服务向第三方提供软件”或不符合的示例？</summary>
   <p></p>
...
ELv2 允许这样做，因为您没有将该软件作为托管服务提供。<br/><br/>

**我是一家为我的客户运行 Databend 的管理服务提供商**

如果您的客户无法访问 Databend，则 ELv2 允许这样做。如果您的客户确实可以访问 Databend 的大部分功能作为您服务的一部分，则可能不允许这样做。
