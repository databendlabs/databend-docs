...
:::tip
- 为了方便您编辑 SQL 语句，您可以在数据库列表中选择一个表，然后点击它旁边的 "..." 按钮。然后，按照菜单提示选择将表名或所有列名一键复制到右侧的 SQL 输入区域。
...
您可以与组织中的所有人或特定个人共享您的 Worksheets。为此，请在要共享的 Worksheet 中点击 **Share**，或点击 **Share this Folder** 以共享 Worksheet 文件夹。
