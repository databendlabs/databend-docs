...
[Addax](https://github.com/wgzhao/Addax) 最初源于阿里巴巴的 [DataX](https://github.com/alibaba/DataX)，是一个通用的开源 ETL (Extract, Transform, Load) 工具。它擅长在各种 RDBMS (关系数据库管理系统) 和 NoSQL 数据库之间无缝传输数据，是高效数据迁移的最佳解决方案。
