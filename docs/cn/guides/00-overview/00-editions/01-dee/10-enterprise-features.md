...
本页面提供了一个更新后的企业版功能列表。要访问这些功能，您需要一个企业版或试用版许可证。更多详情，请参阅[Databend 许可](20-license.md)。
...
| [清理已删除表](/sql/sql-commands/administration-cmds/vacuum-drop-table)            	 | 存储           | 通过删除已删除表的数据文件来优化存储。提供恢复选项和干运行预览。                                                                                                                                                                                                                                                                                                                                     |
| [清理历史数据](/sql/sql-commands/administration-cmds/vacuum-table)            	      | 存储           | 深度清理您的存储空间：<br/>- 移除孤立的段和块文件。 <br/>- 使用干运行选项安全地预览数据文件的移除。                                                                                                                                                                         	                                                                                                                 |
...
本节比较了 Databend 社区版与 Databend 企业版在以下模块中的差异：

### 核心功能

| 功能特性                                         | Databend 社区版       | Databend 企业版      |
|---------------------------------------------------|--------------------------|--------------------------|
| 分布式元数据管理                                 | ✓                        | ✓                        |
| 分布式 SQL 引擎                                  | ✓                        | ✓                        |
| 分布式存储引擎                                   | ✓                        | ✓                        |
