...
本指南将引导您完成将 Databend 查询服务（Query Service）升级到新版本的过程。升级过程包括下载新版发布包、替换二进制文件以及重启服务。

## 下载新版

1. 按照 [准备软件包环境](01-prepare.md) 中的说明下载新版发布包。
...
成功升级查询服务（Query Service）后，您可以：
- [扩展查询服务（Query Service）节点](05-scale-query.md)（适用于多节点部署）
