...
- 升级 Databend 时，你需要分别升级 databend-query 和 databend-meta。你也可以选择只升级其中一个，只要新版本与另一个版本兼容即可。升级前请[检查兼容性](#check-compatibility)。
...
Databend 强烈建议你在仅升级 databend-meta 和 databend-query 中的一个之前，检查它们之间的兼容性。有关如何操作，请参阅 [Query-Meta 兼容性](10-compatibility.md)。
