...
:::note
多集群计算集群默认**未启用**。如需开启，请前往 **Support** > **Create New Ticket** 提交申请。该功能仅对 Databend Cloud **商业版 (Business)** 和 **专用版 (Dedicated)** 用户开放。
:::
...
:::note
MySQL Endpoint 默认**未启用**。如需开启，请前往 **Support** > **Create New Ticket** 提交申请。
:::
