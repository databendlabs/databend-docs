...
服务托管费适用于 Data Integration 服务。与计算集群不同，Data Integration 服务通常 7×24 小时持续运行，直到您主动停止。其计费方式与计算集群一致：**按秒计费**，根据实际运行时长计算，价格取决于服务规格和您所使用的 Databend Cloud 版本。

服务规格基于 Warehouse XSmall 按线性比例换算：`1c4g` 为 XSmall 的 1/8，`2c8g` 为 1/4，`4c16g` 为 1/2。下表中的每月费用按全天候 7×24 小时运行（每月 720 小时）估算，仅供参考。

| 规格  | 每小时费用 (标准版) | 每小时费用 (商业版) | 每月费用 (标准版，24/7) | 每月费用 (商业版，24/7) |
| ----- | ------------------- | ------------------- | ----------------------- | ----------------------- |
| 1c4g  | ￥ 0.375            | ￥ 0.5625           | ￥ 270                  | ￥ 405                  |
| 2c8g  | ￥ 0.75             | ￥ 1.125            | ￥ 540                  | ￥ 810                  |
| 4c16g | ￥ 1.50             | ￥ 2.25             | ￥ 1,080                | ￥ 1,620                |
