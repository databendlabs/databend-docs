...
If you're using [BendSQL](../../11-sql-clients/00-bendsql/index.md) to manage files in a stage, you can use the PUT command for uploading files and the GET command for downloading files.
