...
Download the sample file [employees.parquet](https://datasets.databend.org/employees.parquet) and then upload it to your user stage using [BendSQL](../../11-sql-clients/00-bendsql/index.md). For example,
