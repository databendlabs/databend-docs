...
Databend protects sensitive data at query time without changing stored values:

| Policy | What it does |
|--------|----------------|
| [Masking Policy](/guides/security/data-protection/masking-policy) | Transforms column values — unauthorized users see redacted data |
| [Row Access Policy](/guides/security/data-protection/row-access-policy) | Filters entire rows — unauthorized users never see them |
...
- [Masking Policy](/guides/security/data-protection/masking-policy) — conditional masking, VARIANT keys
- [Row Access Policy](/guides/security/data-protection/row-access-policy) — vector / RAG visibility, time windows, DML
