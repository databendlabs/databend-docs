...
| [**Data Protection Policies**](/guides/security/data-protection-overview) | Protect sensitive data at row and column level | When you need row-level filtering, column-level masking, or both |
...
| [**Row Access Policy**](/guides/security/row-access-policy) | Filter rows dynamically | When users should only see rows that match role-aware access rules |
