...
**Manual**
The task only runs when triggered via **Execute Once**. No automatic scheduling.

**Interval**
Run every N minutes/hours. Example: `EVERY 5 MINUTE`.

**Cron**
Standard cron expression with timezone support. Example: `0 9 * * 1-5` (weekdays at 9am).
