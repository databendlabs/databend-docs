...
Shows a bunch of metrics that Databend captures and tracks about the meta service performance. For more information about the meta service metrics, see [Databend Meta Metrics](../../03-operations/monitoring/10-metasrv-metrics.md).
