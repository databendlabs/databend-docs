...
| [Data Lineage](/guides/data-management/data-lineage)                            | Data Governance | Trace upstream and downstream dependencies between tables, views, stages, and columns. |
...
| [Python UDF](/sql/sql-commands/ddl/udf/ddl-create-function#python)                       | Advanced Analytics | Execute Python code within SQL queries using built-in handler.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| [VACUUM DROPPED OBJECTS](/sql/sql-commands/ddl/table/vacuum-dropped-objects) | Storage Management | Permanently clean up eligible dropped objects and their storage and metadata. Cleaned objects cannot be recovered. |
