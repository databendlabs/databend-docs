...
Follow the [Docker and Local Deployments](../../10-self-hosted/01-deploy/01-non-production/00-deploying-local.md) guide to deploy a local Databend, or deploy a warehouse in the Databend Cloud.
