...
Follow the [Docker and Local Deployments](../../20-self-hosted/02-deployment/20-deploying-local.md) guide to deploy a local Databend, or deploy a warehouse in the Databend Cloud.
