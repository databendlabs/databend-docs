...
If you're using [BendSQL](../../35-connect/00-sql-clients/bendsql/index.md) to manage files in a stage, you can use the PUT command for uploading files and the GET command for downloading files.
