...
| **[Data Recycle](./04-data-recycle.md)** | Free up storage space | • VACUUM Commands<br/>• Retention Policies<br/>• Orphan File Cleanup<br/>• Temporary File Management | • VACUUM TABLE / TABLES<br/>• VACUUM DROPPED OBJECTS<br/>• VACUUM ALL<br/>• DATA_RETENTION_TIME |
