...
|----------|-------------|--------------|------------------|
| **[Data Lifecycle](./01-data-lifecycle/index.md)** | Create and manage objects | • Database & Table <br/>• External Tables<br/>• Streams & Views<br/>• Indexes & Stages<br/>• Table Versioning | • CREATE/DROP/ALTER<br/>• SHOW TABLES<br/>• DESCRIBE TABLE |
