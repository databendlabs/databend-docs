...
- Databend does _not_ support nested transactions, so unmatched transaction statements will be ignored.
...
![alt text](@site/static/img/documents/sql/transaction-id.png)
