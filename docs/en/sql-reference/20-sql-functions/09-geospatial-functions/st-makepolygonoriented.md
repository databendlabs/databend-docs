...
Creates a Polygon from a LineString input, preserving the vertex order as given. Unlike [ST_MAKEPOLYGON](st-makepolygon.md), this function does not reorder vertices to enforce a specific winding direction.
