...
The syntax for INFER_SCHEMA is as follows. For more detailed information about this function, see [INFER_SCHEMA](/15-sql-functions/112-table-functions/infer-schema.md).
