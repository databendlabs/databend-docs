...
To read more about this release, please refer to our detailed [blog post](/blog/databend-release-v1.0). You can also find the full changelog of this release on [GitHub](https://github.com/datafuselabs/databend/releases/tag/v1.0.0-nightly).
